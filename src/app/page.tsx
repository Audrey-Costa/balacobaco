    ...
    <main className="min-h-screen flex flex-row">
      <div className="p-4 flex flex-col justify-start items-end w-40">
        ...
        <div className="h-full w-32 flex flex-row items-start content-start">
          <div className="w-20">
            <h1 className="ml-4 mt-4 tracking-widest -rotate-90 text-4xl h-[500px] w-[500px] flex flex-col text-end">
      ...
      <div className="w-full mt-24">
        <div className="w-full h-[560px] bg-[#3874CE] pt-24">
          <h1 className="__className_6a3ae9 ml-12">
            <p className="text-7xl tracking-[2rem]">
              Estúdio
              <br />
            </p>
            <p className="text-8xl tracking-[2rem]">balacobaco</p>
          </h1>
          <h4 className="mt-6 text-xl indent-80">
            Transformando espaços, Criando memórias.
          </h4>
          <h4 className="mt-48 ml-[600px] text-xl __className_4def21">
            Quando o aconchegô encontra a elegância
          </h4>
        </div>
